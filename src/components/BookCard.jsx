...
//                 <p class="text-sm text-[#64748b] dark:text-[#94a3b8] line-clamp-3 mb-6 mt-4">
//                 {description}
//                 </p>
//                 <div
...
export default function BookCard({
    ...
    return (
        <article class="group flex flex-col bg-white dark:bg-[#1a242f] rounded-xl border border-[#e2e8f0] dark:border-[#293038] p-6 shadow-sm hover:shadow-xl dark:hover:border-primary/50 transition-all duration-300">
            <div class="w-full flex justify-center mb-6 relative">
                <BookCover cover={cover} size="md" variant="flat" />
            ...
            <div class="flex flex-col items-center text-center grow">
                ...
                <div class="mt-auto w-full pt-4 border-t border-[#e2e8f0] dark:border-[#293038] flex justify-between items-center">
                    <span class="text-xs text-[#64748b] capitalize">
